...
# "Navigation Chain" -- excluded directories). Note: shortcuts/ itself is
# NOT excluded -- its ___shortcuts.md doc is tracked; only the per-set
# subfolders inside it are generated/gitignored, and they hold no .md files.
EXCLUDED_DIR_NAMES = {
