...
Root-level loose scripts (`main.py`, `version.py`, `resolver.py`,
`hotkey_daemon.py`) have no package -- their `__about/`/`__flow/` sit
directly under the project root and `README.md` plays the `___folder.md`
role (root DOCS.md, "flat, root-level-only projects" provision, applied
per loose file since this project also has packages).
...
TIERS: dict[str, str] = {
    ...
    "main.py": TRIVIAL,
    "version.py": TRIVIAL,
    "resolver.py": ALGORITHMIC,
    "hotkey_daemon.py": ALGORITHMIC,

    # -- core/ -- the engine ----------------------------------------------------
    "core/__init__.py": TRIVIAL,
    "core/actions.py": STANDARD,
    "core/apply.py": ALGORITHMIC,
    "core/chroma.py": STANDARD,
    "core/keymap.py": STANDARD,
    "core/locations.py": ALGORITHMIC,
    "core/paths.py": STANDARD,
    "core/schedule.py": ALGORITHMIC,
    "core/settings.py": STANDARD,
    "core/solar.py": STANDARD,
    "core/tasks.py": STANDARD,
    "core/updates.py": STANDARD,

    # -- gui/ -- the control panel ------------------------------------------------
    "gui/__init__.py": TRIVIAL,
    "gui/app.py": TRIVIAL,
    "gui/color_groups.py": ALGORITHMIC,
    "gui/colors_tab.py": STANDARD,
    "gui/config_io.py": TRIVIAL,
    "gui/devices_tab.py": ALGORITHMIC,
    "gui/location_picker.py": ALGORITHMIC,
    "gui/main_window.py": ALGORITHMIC,
    "gui/presets_tab.py": STANDARD,
    "gui/shortcuts_tab.py": ALGORITHMIC,
    "gui/theme.py": STANDARD,
    "gui/widgets.py": STANDARD,

    # -- setup/ -- build pipeline --------------------------------------------------
    "setup/build.py": ALGORITHMIC,
    "setup/create_cert.py": STANDARD,
    "setup/svg_to_ico.py": STANDARD,
}
